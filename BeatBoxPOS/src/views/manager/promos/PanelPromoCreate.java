...
public class PanelPromoCreate extends javax.swing.JPanel {
    ...
    private boolean boxesLoading = true;

    public PanelPromoCreate() {
    ...
    private void initComponents() {
        ...
        panelEditFields1 = new javax.swing.JPanel();
        ...
        panelEdit.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add Promo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        panelEdit.setLayout(new java.awt.BorderLayout());

        panelEditFields1.setLayout(new java.awt.GridBagLayout());
        ...
        comboStartYear.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    setSelectedDateRange();validateForm();}
            }
        });
        ...
        comboEndMonth.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED)  {
                    updateDateDays(comboEndMonth, comboEndDay, comboEndYear);validateForm();
                }
            }
        });
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        panelEditFields1.add(scrollPane, gridBagConstraints);
        scrollPane.getVerticalScrollBar().setUnitIncrement(16);

        btnUpdate.setBackground(new java.awt.Color(0, 153, 153));
        btnUpdate.setText("Create Promo");
        ...
        panelEditFields1.add(btnUpdate, gridBagConstraints);
        ...
        panelEditFields1.add(checkUnavailable, gridBagConstraints);

        panelEdit.add(panelEditFields1, java.awt.BorderLayout.CENTER);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String notification = (result) ? constructedDiscount.getDiscountCode() + " Created" : "Error, Please try again! ";
    ...
    private boolean validateForm() {
        ...
        constructedDiscount = new Discount();
        ...
        if (!boxesLoading) {
            ...
            Boolean curUnavailable = checkUnavailable.isSelected();
            ...
            constructedDiscount.setUnavailable(curUnavailable);
    ...
    private javax.swing.JPanel panelEditFields1;
